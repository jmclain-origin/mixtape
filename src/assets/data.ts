...
export const bSide: TrackInfoType[] = [
  {
    ...
    comment: 'Kicking this off with the vibe from the A-side. A love song from Ozzy with some lyrics I can relate to.'
  },
  {
  ...
  },
  {
    ...
    comment: `of course this made the list. Especially cause the other night when you dyed you hair over here. Also I think the song suits you.`
  },
  {
